...
public class RishConfig {
    ...
    public static final int TRANSACTION_createHost = 0;
    public static final int TRANSACTION_setWindowSize = 1;
    public static final int TRANSACTION_getExitCode = 2;
    ...
    public static int getTransactionCode(int code) {
